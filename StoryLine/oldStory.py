            ...
            if escapetownpoliceorcamp == ("Go to the police"):
              ...
              if policeaccuiredsleepoutside == ("Stay the night"):
                ...
                if stayorrunending == ("Run"):
                  ...
                  input("\n\n\nThe game is done. Press Enter to exit.")
                else:
